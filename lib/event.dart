  ...
  void initState() {
    ...
    */
    if (_event != null) {
      ...
      _selDate =
          formatDate(DateTime.fromMillisecondsSinceEpoch(_event.eventDate));
      _selTime = formatTime(TimeOfDay.fromDateTime(
          DateTime.fromMillisecondsSinceEpoch(_event.eventTime)));
  ...
  */
  ...
  void saveEvent() {
    ...
    */
    ...
    var selDTDate = DateTime(year, month, day, 0, 0, 0);
    ...
    var selDTTime = DateTime(year, month, day, hour, minute, 0);
