...
class GuestPage extends State<GuestActivity> {
  ...
  final TextEditingController _controllerVisitTime = TextEditingController();
  ...
  void initState() {
    ...
    */
    if (_guest != null) {
      ...
      DateTime visitTime =
          DateTime.fromMillisecondsSinceEpoch(_guest.guestVisitTime);
      _selVisitTime = formatDate(visitTime) +
          " " +
          formatTime(TimeOfDay.fromDateTime(visitTime));
  ...
  */
  ...
  void saveGuest() {
    ...
    var selVisitTime = DateTime(year, month, day, hour, minute, second);
