// ignore_for_file: sized_box_for_whitespace, list_remove_unrelated_type, deprecated_member_use
...
class GuestsActivity extends StatefulWidget {
  const GuestsActivity({Key key, this.event}) : super(key: key);
  ...
  */
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: const Text("Ingin menghapus tamu?"),
          actions: <Widget>[
            FlatButton(
  ...
  Widget build(BuildContext context) {
    ...
    Widget _blank = Center(
      child: Container(
        height: 40,
        child: const Text("Belum ada tamu"),
      ),
    );
